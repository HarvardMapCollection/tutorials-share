...
<p>Georeferencing historic maps is somewhat more of an art than a science, and the tools can be sensitive. Budget time for troubleshooting. You can use the <a href="https://mapping.share.library.harvard.edu/tutorials/arcgis-qgis/georeference/">georeferencing tutorial </a>to get started.</p>
</div>

<h3>Next steps</h3>

<p>If you&#39;ve successfully georeferenced a map, and would like to learn how to extract data for analysis, check out our tutorial, <a href="https://mapping.share.library.harvard.edu/tutorials/arcgis-qgis/vectorization/">Vectorizing from Historic Maps Tutorial</a>.</p>
